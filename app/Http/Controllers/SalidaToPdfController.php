...
class SalidaToPdfController extends Controller
{
    protected $fpdf;
...
class PDF extends Fpdf
{
    ...
    function Header()
    {
        ...
        $this->Ln(6);
        $this->Cell(0, 4, 'SALIDA DE MATERIAL DEL ALMACEN', 0, 0, 'C', false);
        $this->Ln(15);
    ...
    function footer()
    {
        ...
        $this->Cell($col_width, 4, '', 0, 0, 'C', false);
        $this->Cell($col_width - 10, 4, utf8_decode($subTitulo), 0, 0, 'C', false);
        $this->Cell($col_width, 4, '', 0, 0, 'C', false);
        ...
        $this->Cell($col_width, 4, '', 0, 0, 'C', false);
        $this->Cell($col_width - 10, 4, utf8_decode($subGerencia), 0, 0, 'C', false);
        $this->Cell($col_width, 4, '', 0, 0, 'C', false);
